...
public class Initializer extends Base {
	 ...
	 * Cucumber has Hooks and we have BeforeHooks and AfterHooks Before Hooks
	 * executes a block of code before each scenario After Hooks executes a block of
	 * code after each scenario
	 */
	@Before
